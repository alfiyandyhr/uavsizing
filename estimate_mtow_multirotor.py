...
if __name__ == '__main__':
	...
	# UAV parameters
	uav_params = {}
	uav_params['uav_config'] = 'multirotor'

	# Rotor parameters
	uav_params['n_rotors_lift'] = 6
	...
	indeps.add_output('Rotor|mu', 0.2, units=None)
	...
	prob.model.add_constraint('Rotor|Ct', lower=0.0, upper=0.14 * uav_params['rotor_lift_solidity'], ref=0.01)
	...
	W_motors = prob.get_val('UAV|W_motor_all')
	W_ESCs = prob.get_val('UAV|W_ESC_all')
